...
//If all fields are filled out, sends activation email
	...
	else
	{
	  ...
	  $activationCode = randomCodeGenerator(50);
		$body = 'Please click on this url to activate your account. <br/>
			 <a href="corsair.cs.iupui.edu:23111/lab2/loginPage.php?a='.$activationCode.'">Click Here</a>';

			 // $body = 'Please click on this url to activate your account. <br/>
	 			//  http://corsair.cs.iupui.edu:23111/lab2/loginPage.php?a='.$activationCode;
