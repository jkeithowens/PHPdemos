...
<?php include "RegistrationFormPHP.php"?>
          ...
          <div class="container containerinput" style="margin-top:75px">
            ...
            <div class="head">
              ...
              <!-- Feedback Form Ends Here -->
                ...
                <form action="lab1.php" id="form" method="post" name="form">
                ...
                <?php print $passwordBlank;?><input name="vPassword" placeholder="Enter Password" type="text" value="">

                <?php print $confirmPasswordBlank;?><input name="vConfirmPassword" placeholder="Confirm Your Password" type="text" value="">
