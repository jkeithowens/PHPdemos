          ...
          <div class="container containerinput" style="margin-top:75px">
            ...
            <div class="head">
              ...
              <!-- Feedback Form Ends Here -->
                ...
                <form action="lab5.php" id="form" method="post" name="form">

                <?php print $firstBlank;?><input name="vFirstName" placeholder="First Name" type="text" value='<?php print $_SESSION['first']; ?>'>
                <?php print $lastBlank;?><input name="vLastName" placeholder="Last Name" type="text" value='<?php print $_SESSION['last']; ?>'>
                <?php print $validateBlank;?>
                <?php print $matchEmail;?>
                <?php print $takenMsg;?>
                <?php print $emailBlank;?><input name="vEmail" placeholder="Your Email" type="text" value='<?php print $_SESSION['email']; ?>'>
                <?php print $confirmEmailBlank;?><input name="vConfirmEmail" placeholder="Confirm Your Email" type="text" value='<?php print $_SESSION['confirmEmail']; ?>'>
